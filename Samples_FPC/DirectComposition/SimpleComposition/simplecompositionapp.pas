...
type
  ...
  TDemoApp = class(TObject)
    ...
    private
        ...
        function LoadResourceGDIBitmap( {%H-}resourceName: PCSTR; out hbmp: HBITMAP): HRESULT;
...
begin
    ...
    Fhwnd := CreateWindowA( pAnsiChar('DirectCompDemoApp'),
                            pAnsiChar('DirectComposition Demo Application - please mouse click into window !'),
                            WS_OVERLAPPEDWINDOW,
                            CW_USEDEFAULT,
                            CW_USEDEFAULT,
                            trunc(640.0 * dpiX / 96.0),
                            trunc(480.0 * dpiY / 96.0),
                            0, 0, HINSTANCE, nil);

...
// -----------------------------------------------------------------------------
//
// separate file, extracetd from Tut03.lpr - 2021-04-23
//
// -----------------------------------------------------------------------------
...
const
  ...
  // title of the window
  WindowTitle: String = 'Tut03 - Bz Window';
...
function InitializeWindow( {%H-}Instance: PtrUInt; ShowWnd: integer; Width: integer;
                           Height: integer; fullscreen: boolean): boolean;
...
function InitializeWindow( Instance: PtrUInt; ShowWnd: integer; Width: integer;
                           Height: integer; fullscreen: boolean): boolean;
var
    hMon: HMonitor;
    mi: TMONITORINFO;
...
begin
    ...
    fenceEvent := CreateEvent( LPSECURITY_ATTRIBUTES( 0), False, False, nil);
